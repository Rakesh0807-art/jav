6) b) Design, Develop and Implement a Java program to read a string from the keyboard using an appropriate UI and do the following
                  i.   Extract the middle character of the string
ii. Check whether the string entered is palindrome or not
                  iii. Counting the number of vowels in the string
                   iv. Counting the total number of characters in this string.
